...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Email FROM tblaccountnt WHERE Email=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblaccountant set Password=:newpassword where Email=:email and MobileNumber=:mobile";
